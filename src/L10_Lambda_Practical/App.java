...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Printing cars between price 18000 and 22000");
        printCars(cars, (CarCondition) (c) -> c.getPrice() >= 18000 && c.getPrice() <= 22000);

        System.out.println("Print blue cars");
        printCars(cars, (CarCondition) (c) -> c.getColor().equals("Blue"));
...
//    String stringCar = priceAndColor.apply(car.get(0));
